TODO: need to create patch-package command to replace the `react-native-paper-dropdown` js component file with:

```
import { ScrollView, View, TouchableWithoutFeedbackBase} from "react-native";
...
const DropDown = forwardRef((props, ref) => {
    ...
    return (<Menu visible={visible} onDismiss={onDismiss} theme={theme} anchor={<TouchableRipple rippleColor="transparent" ref={ref} onPress={showDropDown} onLayout={onLayout}>
